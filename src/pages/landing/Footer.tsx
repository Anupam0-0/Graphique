const Footer = () => {
  return (
    <div className='bg-slate-950 px-10  text-slate-50 flex justify-center items-center '>
      <>
      <footer className="relative z-10 pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className='font-extrabold text-4xl tracking-wide mb-8'>
                  Graphique
                </div>
            ...
            <LinkGroup header="Resources">
              <NavLink link="/#" label="Collaborative Design" />
              <NavLink link="/#" label="Our Features" />
              <NavLink link="/#" label="User Guides" />
              <NavLink link="/#" label="Design Strategy" />
            </LinkGroup>
            <LinkGroup header="Company">
              <NavLink link="/#" label="About Convex Clone" />
              <NavLink link="/#" label="Contact & Support" />
              <NavLink link="/#" label="Development History" />
              <NavLink link="/#" label="Terms & Privacy" />
            </LinkGroup>
            <LinkGroup header="Quick Links">
              <NavLink link="/#" label="Support Center" />
              <NavLink link="/#" label="Explore Templates" />
              <NavLink link="/#" label="Meet the Team" />
              <NavLink link="/#" label="Get the App" />
            </LinkGroup>
        ...
        <hr className='mt-12 opacity-50 -mb-5' />
  ...
  return (
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div className="mb-10 w-full">
          <h4 className="mb-9 text-lg font-semibold text-slate-300 dark:text-white">
            {header}
          </h4>
